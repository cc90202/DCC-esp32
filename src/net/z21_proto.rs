...
//! Embassy or ESP dependencies, so protocol behavior is covered by host tests in
//! this file.
//!
//! # Command Coverage
//!
...
//! # Error Handling
//!
//! [`parse_frame`] returns [`ParseError`] for malformed frames:
...
const HEADER_GET_LOCOMODE: u16 = 0x0060;
const HEADER_SET_LOCOMODE: u16 = 0x0061;
const HEADER_RAILCOM_GETDATA: u16 = 0x0089;
const HEADER_LOCONET_DETECTOR: u16 = 0x00A4;
...
const XHEADER_CV_POM: u8 = 0xE6;
const XHEADER_GET_FIRMWARE_VERSION: u8 = 0xF1;
...
const DB0_GET_FIRMWARE_VERSION: u8 = 0x0A;
...
const RESP_LOCOMODE: u16 = 0x0060;
const RESP_RAILCOM_DATACHANGED: u16 = 0x0088;
...
const RESP_XH_CV_RESULT: u8 = 0x64;
const RESP_XH_FIRMWARE_VERSION: u8 = 0xF3;
...
const RESP_DB0_CV_RESULT: u8 = 0x14;
const RESP_DB0_CV_NACK: u8 = 0x13;

const DB0_POM_LOCO: u8 = 0x30;
const POM_OP_READ: u8 = 0xE4;
const POM_OP_WRITE: u8 = 0xEC;
...
fn write_loco_address_be(address: DccAddress, out: &mut [u8], pos: usize) {
