...
pub(crate) type LeaseRequestChannel =
    embassy_sync::channel::Channel<CriticalSectionRawMutex, LeaseRequest<IpEndpoint>, 1>;
pub(crate) type LeaseResponseChannel =
    embassy_sync::channel::Channel<CriticalSectionRawMutex, LeaseDecision<IpEndpoint>, 1>;
...
pub(crate) struct LeaseTripNotification {
    pub(crate) client: IpEndpoint,
    pub(crate) reason: TripReason,
}

pub(crate) struct ClientWatchdogContext {
    pub(crate) request_receiver:
        Receiver<'static, CriticalSectionRawMutex, LeaseRequest<IpEndpoint>, 1>,
    pub(crate) response_sender:
        Sender<'static, CriticalSectionRawMutex, LeaseDecision<IpEndpoint>, 1>,
...
async fn apply_decision(
    decision: LeaseDecision<IpEndpoint>,
