...
use crate::runtime_channels::DccFrameSender;

pub(super) async fn send_power_on_idle_burst(sender: &DccFrameSender) {
...
pub(super) async fn send_decoder_reset_sequence(sender: &DccFrameSender) {
